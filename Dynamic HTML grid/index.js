...
function renderCard( productimages,productNames,productbrand,productprice){
  
   var productCard = document.createElement("div")
   productCard.className = "main-div"

   var productimage = document.createElement("img")
   productimage.className = "image-section"
   productimage.src = productimages
  productCard.appendChild(productimage)
 var productdetail = document.createElement("div")
 productdetail.className="card-details"
 var producttitel = document.createElement("h1")
 producttitel.className = "hhhhh1"
 producttitel.innerText = productNames 
...
var productpriceElement = document.createElement("h5")
 productpriceElement.className = "pricesss"
 productpriceElement.innerText =  productprice

 productdetail.append(producttitel , productbrandElement , productpriceElement )
 productCard.appendChild(productdetail)
// ,, productbrand     productpriceElement
...
return productCard
  ...
  for(var i = 0; i<productList.length; i++){
    var productCard = renderCard(productList[i].preview, productList[i].name, productList[i].brand, "Rs"+ " " + productList[i].price)
